...
const roleConfig = {
    ...
    TEACHER: {
        ...
        icon: (
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C6.5 6.253 2 10.998 2 17s4.5 10.747 10 10.747c5.5 0 10-4.747 10-10.747 0-6.002-4.5-10.747-10-10.747z" />
            </svg>
        ),
    },
    STUDENT: {
