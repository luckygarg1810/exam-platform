        ...
        <Layout>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-card p-6 mb-6 animate-fade-in-up">
                <div className="flex items-center gap-4 mb-5">
                    ...
                    <div>
                        <h1 className="text-xl font-black text-gray-900">Proctor Dashboard</h1>
                    ...
                    {active.length > 0 && (
                        <div className="mb-6">
                            ...
                            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                {active.map((exam, i) => <AssignedExamCard key={exam.id} exam={exam} index={i} onInvigulate={() => navigate(`/proctor/exams/${exam.id}/invigulate`)} />)}
                            </div>
                        </div>
                    )}
                    {upcoming.length > 0 && (
